...
public class MisconfiguredErrorTest implements SauceOnDemandSessionIdProvider {

    /**
     * Test to reproduce "Misconfigured -- Unsupported OS/browser/version/device combo" due to invalid OS version and browser
     */
     ...
     * @param browser
     */
    public MisconfiguredErrorTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"macOS 10.20", "latest", "safri"});
        return browsers;
    }
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Misconfigured Error Test: " + browser + " " + version + ", " + os);
