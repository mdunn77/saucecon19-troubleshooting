...
public class CouldNotStartErrorTest implements SauceOnDemandSessionIdProvider {

    /**
     * Test to reproduce "Sauce could not start your job" due to invalid seleniumVersion requested
     */
     ...
     * @param browser
     */
    public CouldNotStartErrorTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("seleniumVersion", "3.20.0");
        //capabilities.setCapability("iedriverVersion", "3.14.0");
        capabilities.setCapability("name", "Could Not Start Error Test: " + browser + " " + version + ", " + os);
