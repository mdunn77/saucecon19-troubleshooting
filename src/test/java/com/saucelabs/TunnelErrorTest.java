...
public class TunnelErrorTest implements SauceOnDemandSessionIdProvider {
     ...
     * @param browser
     */
    public TunnelErrorTest(String os, String version, String browser) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("tunnelIdentifier", "nosuchtunnel");

        capabilities.setCapability("name", "Tunnel Error Test: " + browser + " " + version + ", " + os);
